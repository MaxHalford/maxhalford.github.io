...
**Edit** -- *since writing this article, I have discovered that the method I describe is a form of [zero-shot learning](https://www.wikiwand.com/en/Zero-shot_learning). So I guess you could say that this article is a tutorial on zero-shot learning for NLP.*
