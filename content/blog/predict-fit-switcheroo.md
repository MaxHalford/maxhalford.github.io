...
I had to make a significant design decision for [River](https://github.com/online-ml/river/). It boils down to the fact that making a prediction with a model pipeline is a stateful operation, whereas users understandably expect it to be pure. This regularly comes up on the issue tracker, as you can see [here](https://github.com/online-ml/river/issues/130), [here](https://github.com/online-ml/river/issues/359), and [here](https://github.com/online-ml/river/issues/499).
